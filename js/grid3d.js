...
;( function( window ) {
		...
		var self = this,
			loadContent = function() {
				...
				setTimeout( function() {
					...
					classie.addClass( self.contentItems[ content_pos ], 'show' );
				}, 1000 );
				// show content area
	...
	grid3D.prototype._hideContent = function() {
		...
		var self = this,
			contentItem = this.el.querySelector( '#main_grid .active' ),
			currentItem = this.gridItems[ this.gridItems.indexOf( contentItem ) ];
