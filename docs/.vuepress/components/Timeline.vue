<template>
  <div
      class="px-3 relative transition-all duration-700 ease-in-out"
      :class="{
        'overflow-y-hidden h-screen': !expend
      }"
  >
    <h3 class="text-6xl font-cursive pt-3 mb-10 text-center">Experience {{ expend }}</h3>
    ...
    <button v-if="!expend" @click="expend = true" class="absolute bottom-0 w-full left-0 text-xl">展開</button>
  </div>
</template>
